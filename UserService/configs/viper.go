...
type ConfigurationsInterface interface {
	...
	JWTConfiguration() models.JWTConfiguration
...
func (v *viperConfiguration) JWTConfiguration() models.JWTConfiguration {
	return models.JWTConfiguration{
		Secret:     v.viper.GetString("JWT_SECRET"),
		ExpiryHour: v.viper.GetInt("JWT_EXPIRY_HOUR"),
	}
...
func (v *viperConfiguration) GRPCConfiguration() models.GRPCConfiguration {
	return models.GRPCConfiguration{
		UserServiceGRPCPort: v.viper.GetInt("USER_SERVICE_GRPC_PORT"),
	}
}
